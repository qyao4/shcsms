<?php
  ...
  if(isset($_POST['command']))
  {
    ...
    if($command == 'Create'){
      $sql = "INSERT INTO Vehicles (make,model,year,price,mileage,exterior_color,description,category_id)  
      VALUES (:make,:model,:year,:price,:mileage,:exterior_color,:description,:category_id)";
      ...
      //  Execute the UPDATE.
      $fields = ['make','model','year','price','mileage','exterior_color','description','category_id'];
      $update_fields = [];
      $bind_values = [];
      foreach($fields as $field){
        if(isset($_POST[$field])){
          $update_fields[] = "$field = :$field";
          $bind_values[$field] = $_POST[$field];
        }
      }
